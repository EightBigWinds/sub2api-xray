...
The current formal Xray release is [v0.2.4-xray5](https://github.com/smmooooonn/sub2api-xray/releases/tag/v0.2.4-xray5), synchronized with official `v0.2.4` and its latest corresponding `main` commits.
